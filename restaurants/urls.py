...
urlpatterns = [
    ...
    path('owner/', OwnerRestaurantListView.as_view(), name='owner_restaurants'),
    path('owner/create/', RestaurantCreateView.as_view(), name='create'),
    path('owner/<int:pk>/edit/', RestaurantUpdateView.as_view(), name='edit'),

    path('owner/<int:restaurant_pk>/products/', OwnerRestaurantProductsView.as_view(), name='owner_restaurant_products'),
